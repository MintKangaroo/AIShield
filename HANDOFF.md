...
- 안정 기준: reproducible clean baseline + bounded FGSM/BIM/PGD/DeepFool + functional dashboard
...
- bounded FGSM/BIM/PGD/DeepFool, paired metrics, norm verification, gradient warning
